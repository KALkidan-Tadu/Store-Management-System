...
root = Tk()
root.title("Store Managment System FOR SHOPS")
root.configure(width=1500,height=600,bg="#ADD8E6")
var=-1
...
def list():
    ...
    root_1.title("Lists of Items")
    scroll = Scrollbar(root_1)  
    scroll.pack( side = RIGHT, fill = Y)
    My_text = Text(root_1, yscrollcommand = scroll.set ,width=24,height= 18 ,bg= "light blue",fg="black", font=("Times", 16))
    string = f.read()
    ...
    with open(r"Proj_Database") as working:
        ...
        try:
           if flag != 1:
            ...
            messagebox.showinfo("Search result", "error end of file")
...
def Exit():
    Exit= messagebox.askyesno("Exit","Do you really want to Exit?")
    if Exit > 0:
        root.destroy()
        return
...
Label_0= Label(root,text="STORE MANAGEMENT FOR SHOPS",fg="black",font=("Times new roman", 30, 'bold'))
Label_0.grid(columnspan=6)

Label_1=Label(root,text="ENTER ITEM NAME",bg="#75E6DA",fg="black",bd=8,font=("Times new roman", 12, 'bold'),width=25)
Label_1.grid(row=1,column=0)
Entry_1=Entry(root, font=("Times new roman", 14),bd=8,width=25)
Entry_1.grid(row=1,column=1)

Label_2=Label(root, text="ENTER ITEM PRICE",height="1",bg="#75E6DA",bd=8,fg="black", font=("Times new roman", 12, 'bold'),width=25)
Label_2.grid(row=2,column=0)
Entry_2= Entry(root, font=("Times new roman", 14),bd=8,width=25)
Entry_2.grid(row=2,column=1)

Label_3=Label(root, text="ENTER ITEM QUANTITY",bg="#75E6DA",bd=8,fg="black", font=("Times new roman", 12, 'bold'),width=25)
Label_3.grid(row=3,column=0)
Entry_3= Entry(root, font=("Times new roman", 14),bd=8,width=25)
Entry_3.grid(row=3,column=1)

Label_4=Label(root, text="ENTER ITEM CATEGORY",bg="#75E6DA",bd=8,fg="black", font=("Times new roman", 12, 'bold'),width=25)
Label_4.grid(row=4,column=0)
Entry_4= Entry(root, font=("Times new roman", 14),bd=8,width=25)
Entry_4.grid(row=4,column=1)

Label_5=Label(root, text="ENTER ITEM DISCOUNT",bg="#75E6DA",fg="black",bd=8, font=("Times new roman", 12, 'bold'),width=25)
...
Button_1= Button(root,text="ADD ITEM",bd=8, bg="#1E3D58", fg="white", width=25, font=("Times new roman", 12),command=Add_Items)
Button_1.grid(row=6,column=0, padx=10, pady=10)
Button_2= Button(root, text="DELETE ITEM",bd=8, bg="#1E3D58", fg="white", width =25, font=("Times new roman", 12),command=Delete_Items)
Button_2.grid(row=6,column=1, padx=40, pady=10)
Button_3= Button(root, text="VIEW STORE",bd=8, bg="#1E3D58", fg="white", width =25, font=("Times new roman", 12),command=list)
Button_3.grid(row=3,column=3, padx=40, pady=10)
Button_4= Button(root, text="SEARCH ITEM",bd=8, bg="#1E3D58", fg="white", width =25, font=("Times new roman", 12),command=Search_Item)
Button_4.grid(row=2,column=3, padx=40, pady=10)
Button_5= Button(root, text="CLEAR SCREEN",bd=8, bg="#1E3D58", fg="white", width=25, font=("Times new roman", 12),command=Clear_Item)
